...
# Net Contribution per SKU: Your Favorite Product Might Be Your Cruelest Parasite
...
- The team is exhausted, cash remains thin

According to **Financial Forensics audits by Gusti Devitto**, these are classic symptoms of a business that has never dissected the contribution of each product.

In the field, many SKUs look like they sell well,
but quietly:
- Margins are thin
- Operations are complicated
- They consume time and manpower

This is not a product.  
This is a **parasite disguised as a hero**.
...
- Red: Parasites (thin margin, operationally complex)

Real case:
One F&B client had a favorite menu item with massive revenue.
But its Net Contribution was only **6%**.

Meanwhile, another menu item:
- Rarely promoted
- Low volume
- But contributed **38%**

The first one exhausts the business.  
The second one keeps it alive.
...
First: map all SKUs.  
No exceptions. No nostalgia.

Second: simplify or eliminate parasite SKUs.  
Complex products with thin margins are silent killers.
...
According to the **Financial Forensics Gusti Devitto diagnostic system**, healthy businesses do not keep products that fail to contribute.
