...
export const Route = createFileRoute('/fip-lite-v2')({
            ...
            <header className="border-b border-white/10 bg-black/50 backdrop-blur-xl sticky top-0 z-50">
                <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-black uppercase tracking-tight">FIP™ Lite v2</h1>
        ...
        <div className="space-y-12 animate-in fade-in duration-1000">
            ...
            <div className="text-center space-y-6 max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-primary">Free 30-Second Diagnostic</span>
                </div>
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                    Business Health <span className="text-primary">MRI Scan</span>
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                    See your financial vulnerabilities in <span className="text-white font-bold">real-time</span>.
                    <br />No fluff. No guesswork. Just brutal forensic truth.
                </p>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="left" className="max-w-[200px] text-[10px]">
                                            <p>Enter nominal currency amount (e.g. $60,000), not percentage. COGS includes raw materials and direct labor.</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
                            <Input
                                ...
                                onChange={(e) => setInputs({ ...inputs, monthlyCOGS: Number(e.target.value) })}
                                className="h-12 bg-black/20 border-white/10 text-lg"
                            />
                        </div>
                    </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="left" className="max-w-[200px] text-[10px]">
                                            <p>Regular monthly expenses like rent, salaries, utilities, and software subscriptions.</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="left" className="max-w-[200px] text-[10px]">
                                            <p>Total liquid cash available in business accounts right now.</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setInputs({ ...inputs, monthlyDebtService: Number(e.target.value) })}
                                className="h-12 bg-black/20 border-white/10 text-lg"
                            />
                        </div>
                        <div className="space-y-2">
...
function ResultsDashboard({ 
    ...
    return (
        <div className="space-y-12 animate-in fade-in zoom-in-95 duration-1000">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    <Card className="border-red-500/20 bg-red-500/5">
                        ...
                        <CardContent className="space-y-2">
                            <div className="text-4xl font-black tabular-nums text-red-400">${layer1.netBurnRate.toLocaleString()}</div>
                    ...
                    <Card className="border-yellow-500/20 bg-yellow-500/5">
                        ...
                        <CardContent className="space-y-2">
                            <div className="text-3xl font-black tabular-nums text-yellow-400">${layer1.breakEvenRevenue.toLocaleString()}</div>
                            ...
                            <div className="text-[10px] text-yellow-400/80 pt-2 border-t border-yellow-500/10">
                                You make: ${layer1.currentRevenue.toLocaleString()}
                            </div>
                        </CardContent>
                    </Card>
                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="text-2xl font-black text-red-400">
                                ${layer2.estimatedLeakage.min.toLocaleString()} — ${layer2.estimatedLeakage.max.toLocaleString()}
                            </div>
                            <div className="text-sm text-muted-foreground">
            ...
            <CTASection layer1={layer1} layer2={layer2} layer3={layer3} onReset={onReset} isEmailUnlocked={isEmailUnlocked} />
        </div>
    )
}
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-[9px] uppercase tracking-widest text-muted-foreground">Critical</div>
                    </div>
                </div>
            </CardHeader>
            ...
            <CardContent className="space-y-6 relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center p-6 z-10">
                        <Card className="w-full max-w-md bg-black/80 backdrop-blur-xl border-primary/30 shadow-2xl animate-in zoom-in-95 duration-500">
                            <CardHeader className="text-center">
                                ...
                                <CardTitle className="text-xl font-black uppercase tracking-tight">Unlock Your Heat Map</CardTitle>
                                <CardDescription className="text-xs">
                                    We've identified <span className="text-red-400 font-bold">{layer3.criticalCount} critical vulnerabilities</span>. Enter your email to see the full 18-pillar breakdown and save your report.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                ...
                <div className="p-6 rounded-2xl bg-red-500/5 border border-red-500/20 space-y-3">
                    ...
                    <div className="text-3xl font-black text-red-400">
                        ${layer3.estimatedAnnualImpact.min.toLocaleString()} — ${layer3.estimatedAnnualImpact.max.toLocaleString()}
                    </div>
                    <div className="text-sm text-muted-foreground">
...
function CTASection({ layer1, layer2, layer3, onReset, isEmailUnlocked }: {
    ...
    const leakageAmount = layer2.estimatedLeakage.max.toLocaleString();
        ...
        <Card className={`border-primary/30 bg-gradient-to-br from-primary/10 to-transparent relative overflow-hidden ${!isEmailUnlocked ? 'opacity-50 grayscale pointer-events-none' : ''}`}>
            ...
            <CardContent className="p-12 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button size="lg" className="h-16 px-12 text-lg font-black uppercase tracking-widest shadow-2xl shadow-primary/30 group">
                        <Lock className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
                        Unlock Full Forensic Audit → $1,200
                    </Button>
                    <Button variant="outline" size="lg" onClick={onReset} className="h-16 px-8">
