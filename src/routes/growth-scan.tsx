        ...
        <div className="space-y-2">
            ...
            <div className="relative">
                ...
                <input 
                    ...
                    className={`w-full bg-white/5 border border-white/10 p-4 ${isCount ? 'px-4' : 'pl-8'} font-mono text-xl focus:border-white focus:outline-none transition-colors rounded-none`}
                    placeholder="0"
                />
            </div>
                ...
                <div className="max-w-2xl mx-auto w-full flex-grow flex flex-col relative z-10">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {step === 1 && (
                                <>
                                    <div className="p-4 bg-white/5 border-l-2 border-emerald-500 text-sm font-light text-white/70 italic">
                    ...
                    <div className="flex justify-between items-center mt-12 pt-8 border-t border-white/10">
                        ...
                        {step < 3 ? (
                            ...
                            <Button 
                                ...
                                className="rounded-none bg-emerald-600 hover:bg-emerald-700 text-white uppercase tracking-widest font-black px-8"
                            >
            ...
            <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-8 border border-white/10 bg-white/[0.02] backdrop-blur relative overflow-hidden">
                        ...
                        <h3 className="text-sm uppercase tracking-widest font-black text-white/50 mb-2">{t('growth_scan.results.ratio_label', 'LTV:CAC Ratio')}</h3>
                        <div className="text-5xl font-mono font-black mb-2 flex items-end gap-2 text-emerald-500">
                    ...
                    <div className="p-8 border border-white/10 bg-white/[0.02] backdrop-blur relative overflow-hidden">
                        <h3 className="text-sm uppercase tracking-widest font-black text-white/50 mb-2">{t('growth_scan.results.bep_label', 'Break-Even Point')}</h3>
                ...
                <div className={`p-8 border ${result.layer2.viabilityVerdict === 'critical' ? 'border-red-500/50 bg-red-500/5' : 'border-white/10 bg-white/5'} flex items-start`}>
