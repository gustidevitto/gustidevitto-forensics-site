    ...
    return (
        <section className="py-24 px-4 md:px-8 border-t border-white/[0.05] bg-[#1c1c1e]">
            <div className="container mx-auto max-w-6xl">
                    ...
                    {phases.map((phase, idx) => (
                        <div key={phase.id} className="relative group">
                            ...
                            <div className="relative z-10 p-7 rounded-squircle-lg glass hover:glass-elevated transition-all duration-300 h-full flex flex-col">
                                ...
                                <div className="text-[10px] font-semibold text-[#AF52DE]/70 uppercase mb-3 tracking-widest glass-sage px-2.5 py-1 rounded-squircle-sm inline-block w-fit">
                                    {phase.actor}
                                </div>
                ...
                {/* Strategic note */}
                <div className="mt-12 p-7 rounded-squircle-xl glass-sage border-[#AF52DE]/15 max-w-3xl mx-auto text-center">
                    <p className="text-sm text-white/60 leading-relaxed">
                        <Trans
                            ...
                            components={{ 1: <span className="text-[#AF52DE] font-semibold" /> }}
                        />
                    </p>
                </div>
            </div>
